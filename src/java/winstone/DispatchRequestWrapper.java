...
public class DispatchRequestWrapper extends HttpServletRequestWrapper {
    ...
    public DispatchRequestWrapper(ServletRequest request,
        ...
        setAtt(isInclude ? INCLUDE_REQUEST_URI : FORWARD_REQUEST_URI,
                requestURI);
        setAtt(isInclude ? INCLUDE_CONTEXT_PATH : FORWARD_CONTEXT_PATH,
                contextPath);
        setAtt(isInclude ? INCLUDE_SERVLET_PATH : FORWARD_SERVLET_PATH,
                servletPath);
        setAtt(isInclude ? INCLUDE_PATH_INFO : FORWARD_PATH_INFO, pathInfo);
        setAtt(isInclude ? INCLUDE_QUERY_STRING : FORWARD_QUERY_STRING,
                queryString);
    ...
    public DispatchRequestWrapper(ServletRequest request,
        ...
        if (originalException != null) {
            ...
            request.setAttribute(ERROR_EXCEPTION_TYPE, originalException
                    .getClass());
