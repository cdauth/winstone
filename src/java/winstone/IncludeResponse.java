...
/**
 * Wraps a normal response, suppressing the headers, and only adding the body.
 * This is useful for Include dispatches, because we just want the body.
 * 
...
public class IncludeResponse extends HttpServletResponseWrapper {
    ...
    public IncludeResponse(ServletResponse response,
            WinstoneResourceBundle resources) {
        super(null);
        super.setResponse(response);
        this.resources = resources;
        this.includedBody = new ByteArrayOutputStream();
        this.servletOutputStream = new WinstoneOutputStream(this.includedBody,
                true, resources);
    }
    ...
    public void finish() throws IOException {
        ...
        String bodyBlock = (underlyingEncoding != null ? new String(
                this.includedBody.toByteArray(), underlyingEncoding)
