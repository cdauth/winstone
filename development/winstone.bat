...
set WINSTONE_OPTS=--prefix=/examples --debug=8 --httpPort=9080 --controlPort=9081 --webroot=c:\java\tomcat\webapps\examples --argumentsRealm.passwd.rickk=rickk --argumentsRealm.roles.rickk=test,tomcat
@rem set WINSTONE_OPTS=--prefix=/examples --debug=7 --webroot=c:\java\tomcat\webapps\examples
@rem set WINSTONE_OPTS=--prefix=/training --debug=7 --httpPort=9080 --controlPort=8081 --webroot=d:\rick\training\build
