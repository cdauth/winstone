...
public class ServletRequestWrapper implements ServletRequest
{
  ...
  public Object getAttribute(String name)         {return this.request.getAttribute(name);}
  public Enumeration getAttributeNames()          {return this.request.getAttributeNames();}
  public void removeAttribute(String name)        {this.request.removeAttribute(name);}
  public void setAttribute(String name, Object o) {this.request.setAttribute(name, o);}

  public String getCharacterEncoding()              {return this.request.getCharacterEncoding();}
  public void setCharacterEncoding(String enc)    {this.request.setCharacterEncoding(enc);}
  ...
  public Locale getLocale()                         {return this.request.getLocale();}
  public Enumeration getLocales()                   {return this.request.getLocales();}
  ...
  public Map getParameterMap()                      {return this.request.getParameterMap();}
  ...
  public String getRemoteHost() {return this.request.getRemoteHost();}
