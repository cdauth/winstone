...
public class TagData implements Cloneable
{
  ...
  public Enumeration getAttributes() {return Collections.enumeration(this.attributes.keySet());}
  ...
  public String getAttributeString(String name) {return (String) this.attributes.get(name);}
}
