...
public class UnavailableException extends ServletException
{
  ...
  /**
   * @deprecated As of Java Servlet API 2.2, with no replacement. Returns
   * the servlet that is reporting its unavailability.
   */
   ...
   */
  public int getUnavailableSeconds() {return this.seconds;}

  /**
   * Returns a boolean indicating whether the servlet is permanently unavailable.
   */
  public boolean isPermanent() {return this.seconds <= 0;}
