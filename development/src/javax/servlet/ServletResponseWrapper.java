...
public class ServletResponseWrapper implements ServletResponse
{
  ...
  public void setLocale(Locale loc) {this.response.setLocale(loc);}
  ...
  public boolean isCommitted()        {return this.response.isCommitted();}
  public int getBufferSize()          {return this.response.getBufferSize();}
  public void setBufferSize(int size) {this.response.setBufferSize(size);}
