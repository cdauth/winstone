...
{
  public static Test suite() {return (new TestSuite(NamingTest.class));}
   ...
   */
  public NamingTest(String name)  {super(name);}
  ...
  public void setUp() throws NamingException
  {
    ...
    env.put(Context.INITIAL_CONTEXT_FACTORY, "com.rickknowles.winstone.jndi.java.javaURLContextFactory");
    env.put(Context.URL_PKG_PREFIXES, "com.rickknowles.winstone.jndi");
