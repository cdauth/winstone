...
/**
 * Enumeration across the names/classes of the bindings in a particular
 * context. Used by the list() method.
 * 
...
public class WinstoneNameEnumeration implements NamingEnumeration
{
   ...
   * Constructor 
   */
  public WinstoneNameEnumeration(Map bindings, WinstoneResourceBundle resources)
  {
  ...
  public boolean hasMore() throws NamingException
  {
    if (this.nameEnumeration == null)
      throw new NamingException(this.resources.getString("WinstoneNameEnumeration.AlreadyClosed"));
    else
