...
/**
 * Extends the winstone output stream, so that the ajp13 protocol
...
public class Ajp13OutputStream extends WinstoneOutputStream
{
  ...
  public void commit() throws IOException
  {
    ...
    if (!this.committed)
    {
      ...
      for (Iterator i = this.owner.getHeaders().iterator(); i.hasNext(); )
      {
        ...
        headerArrayStream.write(headerCode == null ? getStringBlock(headerName) : headerCode);
      ...
      // Write packet header + prefix + status code + status msg + header count
  ...
  public void finishResponse() throws IOException
  {
    ...
    byte endResponse[] = new byte[] {0x41, 0x42, 0x00, 0x02, CONTAINER_END_RESPONSE, 1};
