...
public class WinstoneResponse implements HttpServletResponse
{
                            ...
                            HttpConnector connector)
  {
    ...
    this.outputStream = new WinstoneOutputStream(out);
  ...
  public void verifyContentLength()
  {
    ...
    if (length != null)
    {
      ...
      if (contentLength != bodyBytes)
        Logger.log(Logger.WARNING, "WARNING: Content-length header=" + contentLength +
           " bytes, but only " + bodyBytes + " bytes written to output");
    }
  }
  ...
  public void setLocale(Locale loc) {Logger.log(Logger.WARNING, "Locales not implemented");}
  public Locale getLocale() {Logger.log(Logger.WARNING, "Locales not implemented"); return null;}
  ...
  public PrintWriter getWriter() throws IOException
  {
    ...
    {
      throw new WinstoneException("Error getting printWriter for encoding " +
                                      this.encoding, err);
    }
  }
  ...
  public void sendError(int sc, String msg) throws IOException
  {
    ...
    sw.write("<html><head><title>Error " + sc + "</title></head>");
    sw.write("<body bgcolor=\"#ffffff\"><h1>Error code " + sc + "</h1><br>");
    sw.write(msg);
    sw.write("<hr size=\"1\" width\"90%\">");
    sw.write("<i>Generated by " + req.getWebAppConfig().getServerInfo() +
     " at " + new Date() + "</i>");
    sw.write("</body></html>");

    if (this.encoding == null)
      setContentLength(sw.toString().getBytes().length);
    else
      setContentLength(sw.toString().getBytes(encoding).length);
